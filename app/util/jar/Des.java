...
public class Des {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(getYMD(time));
        System.out.println(getHMS(time));

        Des desObj = new Des();
        String key1 = "chuangdada";
        String key2 = getYMD(time);
        String key3 = getHMS(time);
        String data = "longyi123456";
    ...
    private static String getYMD(long time) {
        Date date = new Date(time);
        SimpleDateFormat format = new SimpleDateFormat("yyyyMMdd");
        return format.format(date);
    }

    private static String getHMS(long time) {
        Date date = new Date(time);
